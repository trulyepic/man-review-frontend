  ...
  return (
    <div className="min-h-[calc(100vh-96px)] bg-[radial-gradient(circle_at_top_left,_rgba(96,165,250,0.18),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(16,185,129,0.16),_transparent_30%),linear-gradient(180deg,_#f8fbff_0%,_#eef5ff_42%,_#f8fafc_100%)] px-4 py-8 dark:bg-[radial-gradient(circle_at_top_left,_rgba(45,212,191,0.16),_transparent_22%),radial-gradient(circle_at_bottom_right,_rgba(251,191,36,0.08),_transparent_26%),linear-gradient(180deg,_#14110f_0%,_#191411_40%,_#1d1714_100%)] sm:px-6 sm:py-10 lg:px-8">
      <div className="mx-auto grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-slate-200/80 bg-white/95 shadow-[0_28px_80px_-40px_rgba(15,23,42,0.35)] dark-theme-shell lg:grid-cols-[1.05fr_0.95fr]">
        <section className="relative overflow-hidden border-b border-slate-200/80 bg-[linear-gradient(145deg,rgba(239,246,255,0.95),rgba(255,255,255,0.98)_52%,rgba(236,253,245,0.88))] px-6 py-7 dark:border-[#322922] dark:bg-[linear-gradient(145deg,rgba(34,27,23,0.98),rgba(24,19,16,0.98)_52%,rgba(29,22,18,0.94))] sm:px-8 sm:py-9 lg:border-b-0 lg:border-r">
          <div className="relative z-10">
            <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-500 dark:text-slate-400">
              {eyebrow}
            </p>
            <h1 className="mt-3 max-w-xl text-3xl font-semibold tracking-tight text-slate-950 dark:text-white sm:text-4xl">
              {title}
            </h1>
            ...
            <div className="mt-8 rounded-[28px] border border-slate-200/70 bg-white/85 p-5 shadow-[0_18px_40px_-34px_rgba(15,23,42,0.38)] dark:border-[#3a3028] dark:bg-[linear-gradient(145deg,_rgba(34,28,24,0.84),_rgba(27,22,19,0.84))] dark:shadow-[0_18px_40px_-34px_rgba(0,0,0,0.75)]">
        ...
        <section className="px-6 py-7 dark:bg-[linear-gradient(180deg,_rgba(26,21,18,0.88),_rgba(20,17,14,0.88))] sm:px-8 sm:py-9">
          {children}
